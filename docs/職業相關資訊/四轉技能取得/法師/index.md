...
16. 再解一次任務「[變身秘藥](遠征王團/闇黑龍王/pre_quest.md#變身秘藥)」，並變身為龍的狀態。
...
17. 跳下去最下面平台，或和 NPC 對話進入到龍洞。
    ...
    | 跳下去最下面平台         | 和 NPC 對話             |
    |------------------------|------------------------|
    | ![天怒/20](天怒/20.png) | ![天怒/21](天怒/21.png) |
...
19. 進入到迷宮室開扁，任何一隻怪物都會掉落任務道具【生命之根】，如果打完整張圖沒有才去下一個迷宮室（第一迷宮室、第二迷宮室等）打怪。若下一張圖仍沒有就再去下一個，依此類推慢慢打。
    - 建議使用【道具掉落率 2 倍券】或【道具掉落率 2 倍券】搭配商城道具【掉保率加倍卡】。

    | 到迷宮室開扁            | 任務道具【生命之根】      |
    |------------------------|------------------------|
    | ![天怒/23](天怒/23.png) | ![天怒/24](天怒/24.png) |
...
2. 打黑翼龍／藍翼龍／赤翼龍取得 20 個龍之心（建議吃道具掉落率 2 倍券打）。
